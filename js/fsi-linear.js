...
const FSI_Linear = {
  ...
  getCurrentSectionData() {
    ...
    switch (section) {
      ...
      case 'expansion_drills':
        return unit.drills?.expansion || [];
      case 'variation_drills':
        return unit.drills?.variation || [];
      case 'translation_drills':
        return unit.drills?.translation || [];
      case 'review':
  ...
  buildReviewItems(unit) {
    ...
    for (const drillType of ['lexical', 'substitution', 'transformation', 'expansion', 'variation', 'translation']) {
  ...
  getUnitProgress(unitNum) {
    ...
    for (const section of this.SECTIONS) {
      ...
      switch (section) {
        ...
        case 'expansion_drills': sectionData = unit.drills?.expansion || []; break;
        case 'variation_drills': sectionData = unit.drills?.variation || []; break;
        case 'translation_drills': sectionData = unit.drills?.translation || []; break;
  ...
  getCompletedSentences() {
    ...
    for (const [key, completed] of Object.entries(this.state.completed)) {
      ...
      switch (section) {
        ...
        case 'expansion_drills': sectionData = unitData.drills?.expansion || []; break;
        case 'variation_drills': sectionData = unitData.drills?.variation || []; break;
        case 'translation_drills': sectionData = unitData.drills?.translation || []; break;
